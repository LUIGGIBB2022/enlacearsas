...
@section('title','Consultar Ventas|Enlace Visual')
...
<div>
    <h4 id = "encab_pagina" class="color_infoencab">Consultar Información de Ventas :: Total $:<span id="totalventas"></h4>
    <div >
        @php
           $fecha = date('Y-m-d');
        @endphp
                   ...
                   <table class ="table table-striped responsive" id="dataventas">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th class = "enc_datatable">Centro Operativo</th>
